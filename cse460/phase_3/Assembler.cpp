 ...
 * File: Assembler.cpp
 * 
 * This program simulates an assembler:
 * Assembles {program}.s files files into {program}.o files
 * These .o files are line by line numbers that are 
 *  ran using VirtualMachine.cpp
**/
